...
import terminal from "../assests/terminal-portfolio.png"
...
const Project = () => {
  ...
  >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
      <div
        className="transform hover:scale-[1.02] transition-all duration-300 w-full"
      >
        <article className="relative border border-green-700 rounded-lg overflow-hidden cursor-pointer transition-all duration-300 hover:border-green-500 bg-black h-full">
          ...
          <div className=" p-4 sm:p-6">
            ...
            Terminal Portfolio - A sleek and interactive personal portfolio designed with a terminal-inspired interface. Built using React and Tailwind CSS to showcase skills, projects, and certificates in a unique and minimalistic style.
            </p>
